...
&nbsp;<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="playerSource">
        ...
        <asp:SqlDataSource ID="playerSource" runat="server" ConnectionString="<%$ ConnectionStrings:vShearthstoneConnectionString %>" SelectCommand="SELECT * FROM [PlayerData] WHERE ([PLAYER_USERNAME] = @PLAYER_USERNAME)">
            <SelectParameters>
